...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("together_whisky.user"))
                .paths(PathSelectors.any())
                .build();
    }

    private Set<String> getConsumeContentTypes() {
        Set<String> consumeContentTypes = new HashSet<String>();
    ...
    private Set<String> getProduceContentTypes() {
        Set<String> produceContentTypes = new HashSet<String>();
